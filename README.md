...
:-------------------------:|:----------------:|:-------------------------:|:------------------:
![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_intro.png)| ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_typing.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_learnSwim.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_learnSwim_scrolled.png) |

Response Action Buttons | ‘Copy’ Selected | Appbar Refresh tapped | Init. Msg Sent AI Responded
:-------------------------:|:---------------:|:---------------------:|:---------------------------:
![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_learnSwim_endScroll.png)| ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_learnSwim_copied.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_refresh.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_explainAI.png) |

Init. Context View | ‘Show More’ View | Reply Sent AI Responded | 2 Msgs in Context
:-------------------------:|:----------------:|:-----------------------:|:-----------------:
![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_history_1_message.png)| ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_history_1_message_showMore.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_aiTakeover.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_history_2_messages.png) |

‘Show More’ View | Reply Sent AI Responded | 3 Msgs in Context | ‘Show More’ View
:-------------------------:|:-----------------------:|:-----------------:|:----------------:
![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_history_2_messages_showMore.png)| ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_sure.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_history_3_messages.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_history_3_messages_showMore.png) |

Stop AI Response | Response Generating View | Response Error View | The End.
:-------------------------:|:------------------------:|:-------------------:|:-------------------------:
![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_responseStopped.png)| ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_generating.png) | ![](https://github.com/tokken10/tellioochat/blob/main/screenshots/chat_screen_responseError.png) |
