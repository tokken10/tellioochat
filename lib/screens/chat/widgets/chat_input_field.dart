  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChatBloc, ChatState>(
      builder: (context, state) {
        ...
        final bool isResponseStreaming = state is ChatLoaded &&
            (state.isTyping || state.isGeneratingResponse);

        // Checks if a conversation exists
        final bool hasConversation = state is ChatLoaded &&
            state.currentConversation.isNotEmpty;
